  ...
  <v-container class="pa-0">
    ...
    <v-card>
      <v-card-text>
        ...
        <p>
          Responsible party pursuant to data protection laws, in particular the
          EU General Data Protection Regulation (GDPR), is
        </p>
        <p>Sabahattin Giritli</p>
        <h2>Processing of personal data</h2>
        <p>
          We have no interest in your personal data. We do not store or pass on
          your data to other systems. Solely to implement the functionality of
          the Workout Companion App the data is processed by the following
          system components.
        </p>
        ...
        <h3>Google APIs</h3>
        <p>
          When you log in with Google, you will be asked to give our app access
          to the data listed below. We process this data for the reasons
          mentioned.
        </p>
        <ul>
          <li>
            Google profile data you have made public and the email address: For
            the purpose of displaying this information in the app for your
            orientation (for example, the email address is required so that we
            can display it to you after you log in. By displaying it, you know
            which account you logged in).
          </li>
          <li>
            Your Google Drive files: For the purpose of selecting a spreadsheet
            file from your google drive.
          </li>
          <li>
            Your Google Spreadsheet files: For the purpose of storage and access
            to your stored workout data (e.g. for storing your sets of
            exercises).
          </li>
        </ul>
        <p></p>
        ...
        <ul>
          ...
          <li>
            Restriction of the data processing, provided that we may not delete
        ...
        <p>
          ...
          e.g. the supervisory authority of the state of your residence or the
          authority that oversees us as the responsible party.
        </p>
        <p>
        ...
        <h3>Type and purpose of the processing</h3>
        <p>
          When you access our website – i.e. if you do not register or submit
          information – information of a general nature will be collected
          automatically. This information (server log files) contains the type
        ...
        <p>
          We will not use your data to draw conclusions about your person. This
          type of information will be statistically analysed by us if necessary
          to optimise our website and its underlying technology.
        </p>
        <h3>Legal basis</h3>
        <p>
          The processing occurs according to Art. 6 Para. 1 (f) GDPR, based on
          our legitimate interest in improving the stability and functionality
          of our website.
        </p>
        <h3>Recipients</h3>
        <p>
          Recipients of the data may be technical service providers, who work on
          the operation and maintenance of our website as the processor.
        </p>
        <h3>Retention period</h3>
        <p>
          The data will be deleted as soon as they are no longer required for
          the reason they were collected. This is generally the case, after the
          respective session has ended, for data that are used to make the
          website available.
        </p>
        <h3>Mandatory or required provision</h3>
        <p>
          The provision of the aforementioned personal data is neither legally
          nor contractually mandatory. Without the IP address however, the
          service and functionality of our website are not guaranteed.
          Furthermore, individual services can be unavailable or limited. For
          this reason, an objection is excluded.
        </p>
        <p></p>
        <h2>Using script libraries (Google Webfonts)</h2>
        <h3>Type and purpose of the processing</h3>
